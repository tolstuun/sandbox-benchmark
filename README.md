...
- `runner/`: C++17 native runner built with CMake and MSVC. The runner executes the selected checks and logs results.
...
- one synthetic demo result, `demo.runner_start`, to validate the execution and logging path
